          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
              ...
              <p className="text-gray-600">
                Located at 7 Autumn Road, West House, Devcon Park, Rivonia, Johannesburg, Account Caddie is strategically positioned to serve businesses across South Africa.
              </p>
              <Button className="bg-chelsea-cucumber text-white hover:bg-te-papa-green text-lg px-8 py-3 mt-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-chelsea-cucumber mb-4">Expertise</h3>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-chelsea-cucumber mb-4">Integrity</h3>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-chelsea-cucumber mb-4">Innovation</h3>
